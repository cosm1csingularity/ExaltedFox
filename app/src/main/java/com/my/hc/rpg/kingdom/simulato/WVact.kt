...
import com.my.hc.rpg.kingdom.simulato.Constants.CAML2
import com.my.hc.rpg.kingdom.simulato.Constants.CAML3
...
class WVact : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_wvact)

        view1 = findViewById(R.id.ExFxView)
    ...
    private fun getUrl(): String {
        ...
        val cpOne: String? = Hawk.get(CAML1)
        val cpTwo: String? = Hawk.get(CAML2)
        val cpThree: String? = Hawk.get(CAML3)
        ...
        val pack = "com.my.hc.rpg.kingdom.simulato"
        ...
        val first = "https://"
        val second = "exaltedfox.site/8uyS2"
